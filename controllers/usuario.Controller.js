...
export const editarUsuario = async (req, res) => {
  ...
  try {
    ...
    return res
      .status(200)
      .json({ msg: "Usuario actualizado correctamente", usuario });
  } catch (error) {
    console.error(error);
...
export const editarPasswordUsuario = async (req, res) => {
  console.log(
    "Editando password usuario ......",
  ...
  try {
    ...
    return res
      .status(200)
      .json({ msg: "Password actualizado correctamente", usuario });
  } catch (error) {
    console.error("❌ Error al actualizar el password del usuario:", error);
